...
namespace TutorConnect.Controllers
{
    public class TutorController : Controller
    {
        ...
        public TutorController(TutorConnectDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TutorId,FullName,Email,Subject")] Tutor tutor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TutorId,FullName,Email,Subject")] Tutor tutor)
        {
            if (id != tutor.TutorId)
            {
                return NotFound();
